...
wget -q -O /usr/local/bin/edussh-nontls https://raw.githubusercontent.com/XC0D3-X/VPS-SC/patch-1/proxy-template.py
...
wget -q -O /usr/local/bin/edu-ovpn https://raw.githubusercontent.com/XC0D3-X/VPS-SC/patch-1/edu-op.py
