...
wget -q -O /usr/local/harithwyd/xray-mini "https://raw.githubusercontent.com/XC0D3-X/VPS-SC/patch-1/xray-mini"
...
# // Downloading Menu
wget -q -O /usr/bin/add-xray "https://raw.githubusercontent.com/XC0D3-X/VPS-SC/patch-1/add-xray.sh"
wget -q -O /usr/bin/del-xray "https://raw.githubusercontent.com/XC0D3-X/VPS-SC/patch-1/del-xray.sh"
wget -q -O /usr/bin/renew-xray "https://raw.githubusercontent.com/XC0D3-X/VPS-SC/patch-1/renew-xray.sh"
